...
//public class ParserUsuario : ParserBase<PersonalInterno>
//{
//    public ParserUsuario(string fileName) : base(fileName)
//    {
//    }

//    protected override string ConvertToLine(PersonalInterno item)
//    {
//        // Lógica para convertir un objeto Usuario a una línea del archivo
//        return $"{item.Id},{item.Nombre},{item.Usuario},{item.Contrasenia},{item.Role}";
//    }



//    protected override PersonalInterno ParseLine(string linea)
//    {
//        // Lógica para parsear una línea del archivo y crear un objeto de tipo Usuario
...
//            Logica.Usuarios.Persona usuario = new Logica.Usuarios.PersonalInterno(int.Parse(valores[0]), valores[1], valores[2], valores[3], Enum.Parse<Role>(valores[4]));
